...
class PDFProcessor:
            ...
            try:
                with fitz.open(pdf_path) as doc:
                    ...
                    if not pdf_content.strip():
                        ...
                        print("\n=== Extracted Text from PDF (Text-based) ===")
                        print(pdf_content)
    ...
    def _process_image_based_pdf(self, pdf_path):
        try:
            ...
            print("\n=== Extracted Text from PDF (Image-based) ===")
...
{{{{
  ...
  "transaction_details": {{{{
    "transaction_id": "order_Po7qfDGPPZTrj5",
    "reference_id": "pay_Po7qyZeWRn1p3Q",
    "date": "26/01/2025",
    "time": "21:13:31 IST",
    "status": "successful",
    "total_amount": 1000,
  ...
  "items": [
    {{{{
      "description": "Conservation Economics",
      "amount": 1000,
      "quantity": 1,
      "type": "course"
    }}}}
  ...
  "support_info": {{{{
    "email": "support@nptel.iitm.ac.in"
  }}}},
  "additional_notes": "If your transaction was successful, payment receipts will be available once the form closes."
}}}},
